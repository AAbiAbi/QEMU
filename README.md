...
to enable port mapping from 8888 to 22 and run the SSH command shown below. ● -netdevuser,id=net0,hostfwd=tcp::8888-:22
● $ssh-p8888localhost
...
○ You need a total of two sysbench test cases for CPU, two test cases for
fileio and two test cases for memory.
